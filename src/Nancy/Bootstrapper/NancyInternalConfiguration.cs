        ...
        public static NancyInternalConfiguration Default
        {
            get
            {
                return new NancyInternalConfiguration
                {
                    ...
                    StatusCodeHandlers = new List<Type>(new[] { typeof(DefaultStatusCodeHandler) }.Concat(AppDomainAssemblyTypeScanner.TypesOf<IStatusCodeHandler>(ScanMode.ExcludeNancy))),
                    ...
                    InteractiveDiagnosticProviders = new List<Type>(AppDomainAssemblyTypeScanner.TypesOf<IDiagnosticsProvider>(ScanMode.All)),
                    RequestTracing = typeof(DefaultRequestTracing),
                    RouteInvoker = typeof(DefaultRouteInvoker),
                    ResponseProcessors = AppDomainAssemblyTypeScanner.TypesOf<IResponseProcessor>(ScanMode.All).ToList(),
